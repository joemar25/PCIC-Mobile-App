// // filename: ppir_form/pcic_form.dart (old)
// import 'dart:io';
...
//         '${widget.task.lastCoordinates.latitude}, ${widget.task.lastCoordinates.longitude}';
//   }
...
//     final distance = mapService.calculateTotalDistance(widget.task.routePoints);

//     double area = 0.0;
//     double areaInHectares = 0.0;

//     if (widget.task.routePoints.isNotEmpty) {
//       final initialPoint = widget.task.routePoints.first;
//       final closingPoint = widget.task.routePoints.last;

//       if (_isCloseEnough(initialPoint, closingPoint)) {
//         area = mapService.calculateAreaOfPolygon(widget.task.routePoints);
...
//                 const SizedBox(height: 16),
//                 GPXFileButtons(
//                   openGpxFile: () => _openGpxFile(widget.task.gpxFilePath),
//                 ),
//               ],
//             ),
//           ),
